...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/helmetHaving.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/helmetHaving.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	﻿<div id="page">
	<?php $__FOR_START_880482525__=0;$__FOR_END_880482525__=$pageNum;for($i=$__FOR_START_880482525__;$i < $__FOR_END_880482525__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
