...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/materialAll.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/materialAll.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	<?php if(is_array($materials)): $i = 0; $__LIST__ = $materials;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$material): $mod = ($i % 2 );++$i;?><ul>
			<li><?php echo ($i); ?></li>
			<li><?php echo ($material["id"]); ?></li>	
			<li><?php echo ($material["name"]); ?></li>	
			<li><?php echo ($material["type"]); ?></li>	
			<li contenteditable="true"><?php echo ($material["num"]); ?></li>	
			<li>999</li>
		</ul><?php endforeach; endif; else: echo "" ;endif; ?>
	﻿<div id="page">
	<?php $__FOR_START_1868160054__=0;$__FOR_END_1868160054__=$pageNum;for($i=$__FOR_START_1868160054__;$i < $__FOR_END_1868160054__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
