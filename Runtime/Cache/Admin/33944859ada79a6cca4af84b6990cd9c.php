...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/accountWhite.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/accountWhite.js?<?php echo time();?>"></script>

<div id="right">
	<form action="/resource/index.php?m=Admin&amp;c=Account&amp;a=white" method="post">
		<p>
			<?php if($tips == 1): ?><span>该账号不存在</span>
			<?php elseif($tips == 2): ?>
				<span>该账号未建立角色</span>
			<?php elseif($tips == 3): ?>
				<span>添加成功</span><?php endif; ?>	
		</p>
		<p>
