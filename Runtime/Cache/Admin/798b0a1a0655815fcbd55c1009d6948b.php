...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/monsterHaving.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/monsterHaving.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	<?php if(is_array($user_monsters)): $i = 0; $__LIST__ = $user_monsters;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user_monster): $mod = ($i % 2 );++$i;?><ul>
			<li><?php echo ($i); ?></li>
			<li><?php echo ($user_monster["user_monster"]); ?></li>	
			<li><?php echo ($user_monster["name"]); ?></li>	
			<li><?php echo ($user_monster["level"]); ?></li>	
			<li><?php echo ($user_monster["exp"]); ?></li>	
			<li><?php echo ($user_monster["hp"]); ?></li>	
			<li><?php echo ($user_monster["attack"]); ?></li>	
			<li><?php echo ($user_monster["defense"]); ?></li>
			<li><a href="javascript:;">删除</a></li>
		</ul><?php endforeach; endif; else: echo "" ;endif; ?>
	﻿<div id="page">
	<?php $__FOR_START_1376912121__=0;$__FOR_END_1376912121__=$pageNum;for($i=$__FOR_START_1376912121__;$i < $__FOR_END_1376912121__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
