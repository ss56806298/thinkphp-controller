...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/armorAll.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/armorAll.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	<?php if(is_array($armors)): $i = 0; $__LIST__ = $armors;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$armor): $mod = ($i % 2 );++$i;?><ul>
			<li><?php echo ($i); ?></li>
			<li><?php echo ($armor["id"]); ?></li>	
			<li><?php echo ($armor["name"]); ?></li>	
			<li><?php echo ($armor["default_attack"]); ?></li>	
			<li><?php echo ($armor["default_defense"]); ?></li>
			<?php if($armor["isHaving"] == 1): ?><li><a href="javascript:;">删除</a></li>
				<li>已拥有</li>
			<?php else: ?>
	...
	﻿<div id="page">
	<?php $__FOR_START_2091257133__=0;$__FOR_END_2091257133__=$pageNum;for($i=$__FOR_START_2091257133__;$i < $__FOR_END_2091257133__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
