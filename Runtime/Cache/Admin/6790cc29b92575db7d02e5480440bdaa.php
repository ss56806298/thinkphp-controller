...
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/materialHaving.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	﻿<div id="page">
	<?php $__FOR_START_527421587__=0;$__FOR_END_527421587__=$pageNum;for($i=$__FOR_START_527421587__;$i < $__FOR_END_527421587__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
