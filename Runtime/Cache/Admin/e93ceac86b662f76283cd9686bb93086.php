...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/monsterAll.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/monsterAll.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	<?php if(is_array($monsters)): $i = 0; $__LIST__ = $monsters;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$monster): $mod = ($i % 2 );++$i;?><ul>
			<li><?php echo ($i); ?></li>
			<li><?php echo ($monster["id"]); ?></li>	
			<li><?php echo ($monster["name"]); ?></li>	
			<li><?php echo ($monster["default_hp"]); ?></li>	
			<li><?php echo ($monster["default_attack"]); ?></li>	
			<li><?php echo ($monster["default_defense"]); ?></li>
			<?php if($monster["isHaving"] == 1): ?><li><a href="javascript:;">删除</a></li>
				<li>已拥有</li>
			<?php else: ?>
	...
	﻿<div id="page">
	<?php $__FOR_START_1691435763__=0;$__FOR_END_1691435763__=$pageNum;for($i=$__FOR_START_1691435763__;$i < $__FOR_END_1691435763__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
