...
<link rel="stylesheet" href="<?php echo (ADMIN_PUBLIC); ?>/css/armorHaving.css?<?php echo time();?>">
<script src="<?php echo (ADMIN_PUBLIC); ?>/js/armorHaving.js?<?php echo time();?>"></script>
...
<div id="right">
	...
	<?php if(is_array($user_guards)): $i = 0; $__LIST__ = $user_guards;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user_guard): $mod = ($i % 2 );++$i;?><ul>
			<li><?php echo ($i); ?></li>
			<li><?php echo ($user_guard["item_id"]); ?></li>	
			<li><?php echo ($user_guard["name"]); ?></li>	
			<li><?php echo ($user_guard["level"]); ?></li>	
			<li><?php echo ($user_guard["exp"]); ?></li>	
			<li><?php echo ($user_guard["attack"]); ?></li>	
			<li><?php echo ($user_guard["defense"]); ?></li>
			<li><a href="javascript:;">删除</a></li>
		</ul><?php endforeach; endif; else: echo "" ;endif; ?>
	﻿<div id="page">
	<?php $__FOR_START_1550225376__=0;$__FOR_END_1550225376__=$pageNum;for($i=$__FOR_START_1550225376__;$i < $__FOR_END_1550225376__;$i+=1){ if($i == $page): ?><a href=<?php echo U("", array("page" => $i));?> class="page_active"><?php echo ($i+1); ?></a>
		<?php else: ?>
